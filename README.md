...
The design is based on NEMA-17 motors of any size, but to avoid using an external converter to power the arduino, a voltage <=12V is recommended. So low resistance motors are prefered. Any standard 16 pins stepper driver can be used, and a sparkfun distance sensor (https://www.sparkfun.com/products/15569)... And 2 685 miniature ball bearings for the pump's rotor.
